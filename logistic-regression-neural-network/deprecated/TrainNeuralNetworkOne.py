...
def main():
    ...
    for epoch in range(epochs):
        ...
        # update weights
        new_weights1 = learningRate * a1_acum_delta2 / (x_layer_train.shape[0] / mini_batch)
        new_weights2 = learningRate * a2_acum_delta3 / (x_layer_train.shape[0] / mini_batch)
        NN.weights1 -= new_weights1
        NN.weights2 -= new_weights2
